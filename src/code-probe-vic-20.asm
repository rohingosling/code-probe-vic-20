...
// KERNAL routines (VIC-20 jump table).
...
// forced-address variant (SA = 0) was removed because the L command
// now picks the mode from the token count — if an address is
// supplied the SEQ path (OPEN + CHRIN loop) is used instead of
// KERNAL_LOAD.
...
//
//   Port of the Alter mode in the C64 v2.1 reference at
...
//   semantics of this 1988-compatible reconstruction.
//
...
// programs authored with Code Probe live. This figure is the primary
